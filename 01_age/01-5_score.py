...
glycolysis_genes = ['Gpi1','Aldoa','Gapdh','Pkm','Eno1','Pgam1','Tpi1','Pgk1','Hk1','Hk2','Pfkl','Pfkm','Eno2','Pklr']
#'Hkdc1','Pgam2',
import matplotlib.pyplot as plt
...
glucose_genes = ['Slc2a8','Slc2a5','Slc5a11','Slc5a3','Slc2a1','Slc2a10','Slc2a3','Slc2a4','Slc2a9','Gm5134']

#'Slc2a2', 'Slc45a1', 'Slc5a1', 'Slc5a10', 'Slc5a2', 'Slc5a4b', 'Slc5a9'

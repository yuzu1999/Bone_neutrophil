...
write.csv(Neu_1_VS_Non_neu,"./GLM/Neu_1_VS_Non_neu.csv",quote=FALSE)
write.csv(Neu_2_VS_Non_neu,"./GLM/Neu_2_VS_Non_neu.csv",quote=FALSE)
write.csv(Neu_3_VS_Non_neu,"./GLM/Neu_3_VS_Non_neu.csv",quote=FALSE)
write.csv(Neu_4_VS_Non_neu,"./GLM/Neu_4_VS_Non_neu.csv",quote=FALSE)
write.csv(Neu_5_VS_Non_neu,"./GLM/Neu_5_VS_Non_neu.csv",quote=FALSE)
write.csv(Neu_6_VS_Non_neu,"./GLM/Neu_6_VS_Non_neu.csv",quote=FALSE)
write.csv(Neu_7_VS_Non_neu,"./GLM/Neu_7_VS_Non_neu.csv",quote=FALSE)
...
Neu_1_VS_Non_neu <- read.csv("./GLM/Neu_1_VS_Non_neu.csv",header=TRUE,row.names=1)
Neu_2_VS_Non_neu <- read.csv("./GLM/Neu_2_VS_Non_neu.csv",header=TRUE,row.names=1)
Neu_3_VS_Non_neu <- read.csv("./GLM/Neu_3_VS_Non_neu.csv",header=TRUE,row.names=1)
Neu_4_VS_Non_neu <- read.csv("./GLM/Neu_4_VS_Non_neu.csv",header=TRUE,row.names=1)
Neu_5_VS_Non_neu <- read.csv("./GLM/Neu_5_VS_Non_neu.csv",header=TRUE,row.names=1)
Neu_6_VS_Non_neu <- read.csv("./GLM/Neu_6_VS_Non_neu.csv",header=TRUE,row.names=1)
Neu_7_VS_Non_neu <- read.csv("./GLM/Neu_7_VS_Non_neu.csv",header=TRUE,row.names=1)



'''
Neu_1 <- rownames(Neu_1_VS_Non_neu)[which(Neu_1_VS_Non_neu$t_abs > 80)]
Neu_2 <- rownames(Neu_2_VS_Non_neu)[which(Neu_2_VS_Non_neu$t_abs > 80)]
Neu_3 <- rownames(Neu_3_VS_Non_neu)[which(Neu_3_VS_Non_neu$t_abs > 80)]
Neu_4 <- rownames(Neu_4_VS_Non_neu)[which(Neu_4_VS_Non_neu$t_abs > 80)]
Neu_5 <- rownames(Neu_5_VS_Non_neu)[which(Neu_5_VS_Non_neu$t_abs > 80)]
Neu_6 <- rownames(Neu_6_VS_Non_neu)[which(Neu_6_VS_Non_neu$t_abs > 80)]
Neu_7 <- rownames(Neu_7_VS_Non_neu)[which(Neu_7_VS_Non_neu$t_abs > 80)]
...
write.table(data.frame(TFs=TFs),"./GLM/Neu_VS_Non_neu_TFs.txt",quote=FALSE,row.names=FALSE)

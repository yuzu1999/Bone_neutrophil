...
pdata <- read.csv("OVX_cellinfo.csv",header=TRUE,row.names=1)
head(pdata)

exprSet <- fread("OVX_activity.csv",header=TRUE)
exprSet[1:4,1:4]
...
write.csv(Neu_1_VS_Non_neu,"./OVX_GLM/Neu_1_VS_Non_neu.csv",quote=FALSE)
write.csv(Neu_2_VS_Non_neu,"./OVX_GLM/Neu_2_VS_Non_neu.csv",quote=FALSE)
write.csv(Neu_3_VS_Non_neu,"./OVX_GLM/Neu_3_VS_Non_neu.csv",quote=FALSE)
write.csv(Neu_4_VS_Non_neu,"./OVX_GLM/Neu_4_VS_Non_neu.csv",quote=FALSE)
write.csv(Neu_5_VS_Non_neu,"./OVX_GLM/Neu_5_VS_Non_neu.csv",quote=FALSE)
write.csv(Neu_6_VS_Non_neu,"./OVX_GLM/Neu_6_VS_Non_neu.csv",quote=FALSE)
write.csv(Neu_7_VS_Non_neu,"./OVX_GLM/Neu_7_VS_Non_neu.csv",quote=FALSE)




Neu_1_VS_Non_neu <- read.csv("./OVX_GLM/Neu_1_VS_Non_neu.csv",header=TRUE,row.names=1)
Neu_2_VS_Non_neu <- read.csv("./OVX_GLM/Neu_2_VS_Non_neu.csv",header=TRUE,row.names=1)
Neu_3_VS_Non_neu <- read.csv("./OVX_GLM/Neu_3_VS_Non_neu.csv",header=TRUE,row.names=1)
Neu_4_VS_Non_neu <- read.csv("./OVX_GLM/Neu_4_VS_Non_neu.csv",header=TRUE,row.names=1)
Neu_5_VS_Non_neu <- read.csv("./OVX_GLM/Neu_5_VS_Non_neu.csv",header=TRUE,row.names=1)
Neu_6_VS_Non_neu <- read.csv("./OVX_GLM/Neu_6_VS_Non_neu.csv",header=TRUE,row.names=1)
Neu_7_VS_Non_neu <- read.csv("./OVX_GLM/Neu_7_VS_Non_neu.csv",header=TRUE,row.names=1)
...
write.table(data.frame(TFs=TFs),"./OVX_GLM/Neu_VS_Non_neu_TFs.txt",quote=FALSE,row.names=FALSE)

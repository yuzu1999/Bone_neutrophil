...
write.csv(tmp_vs_Other_neu,"./OVX_GLM/Neu_7_vs_Other_neu.csv",quote=FALSE)
...
Neu_6_vs_Other_neu <- read.csv("./OVX_GLM/Neu_6_vs_Other_neu.csv",header=TRUE,row.names=1)

Neu_6 <- rownames(arrange(Neu_6_vs_Other_neu,-t_abs))[1:20]

#Neu_6 <- rownames(Neu_6_vs_Other_neu)[which(Neu_6_vs_Other_neu$t_abs > 40)]

write.table(data.frame(TFs=Neu_6),"./OVX_GLM/Neu_Cluster_6_TFs.txt",quote=FALSE,row.names=FALSE)
...
Neu_1_vs_Other_neu <- read.csv("./OVX_GLM/Neu_1_vs_Other_neu.csv",header=TRUE,row.names=1)
Neu_2_vs_Other_neu <- read.csv("./OVX_GLM/Neu_2_vs_Other_neu.csv",header=TRUE,row.names=1)
Neu_3_vs_Other_neu <- read.csv("./OVX_GLM/Neu_3_vs_Other_neu.csv",header=TRUE,row.names=1)
Neu_4_vs_Other_neu <- read.csv("./OVX_GLM/Neu_4_vs_Other_neu.csv",header=TRUE,row.names=1)
Neu_5_vs_Other_neu <- read.csv("./OVX_GLM/Neu_5_vs_Other_neu.csv",header=TRUE,row.names=1)
Neu_6_vs_Other_neu <- read.csv("./OVX_GLM/Neu_6_vs_Other_neu.csv",header=TRUE,row.names=1)
Neu_7_vs_Other_neu <- read.csv("./OVX_GLM/Neu_7_vs_Other_neu.csv",header=TRUE,row.names=1)
...
write.table(data.frame(TFs=TFs),"./OVX_GLM/Neu_Cluster_TFs.txt",quote=FALSE,row.names=FALSE)
